...
const S: any = {
  ...
  bodyWithStickyHeader: { padding: "24px 16px 120px", position: "relative", zIndex: 1, maxWidth: "540px", import React, { useCallback, useEffect, useMemo, useRef, useState } from "react";
...
const S: any = {
  ...
  bodyWithStickyHeader: { padding: "24px 16px 120px", position: "relative", zIndex: 1, maxWidth: "540px", margin: "0 auto",marginTop: "80px" },
